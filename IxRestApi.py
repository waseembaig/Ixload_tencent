...
class Connection(object):
    ...
    def _get_http_session(self):
        ...
        if self.http_session is None:
            ...
            if not self.http_redirect:
                ...
                http_adapter.poolmanager = PoolManager(ssl_version=ssl.PROTOCOL_TLSv1_2)
    ...
    def _request(self, method, url="", data="", params=None, headers=None):
        '''
        '''
        if method == "post":
    ...
    def http_request(self, method, url="", data="", params=None, headers=None, downloadStream=False, timeout=80):
        '''
            Args:
        ...
        result = self._get_http_session().request(method, abs_url, data=str(data), params=params, headers=headers, verify=False, timeout=timeout, stream=downloadStream)
        return result
    
    def httpRequest2(self, method, url="", data="", params={}, query={}, headers={}, downloadStream=False, timeout=80):
        '''
            Args:
        ...
        result = self._get_http_session().request(method, absUrl, data=str(data), params=params, headers=headers, verify=False, timeout=timeout, stream=downloadStream)
        return result

    def http_get(self, url="", data="", params=None, headers=None, stream=None, error_codes=None, option=None):
        '''
        ...
        reply = self.http_request("GET", url, data, params, headers, stream)
